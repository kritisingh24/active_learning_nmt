...
def translate(
    ...
    if not sys.stdin.isatty() and not cfg['active_learning'].get('query_strategy',None):  # pylint: disable=too-many-nested-blocks
        # input stream given
        ...
        while True:
            try:
                ...
                hypotheses, tokens, scores, _, batch_results = _translate_data(test_data, test_cfg)
